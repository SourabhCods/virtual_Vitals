    ...
    <div className='bg-blue-200 w-screen h-screen' >
      ...
      <div id='dashboard-section'>
        ...
        <div id="personal-info">
          ...
          <h1 className='text-white font-bold text-2xl relative bottom-7'>{name}</h1>
        </div>
        ...
        <div id="appointments">
          <div style={{width: '105.4%',height: '19%',position: 'relative', right: '11px', bottom: '10px', overflow: 'hidden', borderTopLeftRadius: '10px', borderTopRightRadius: '10px', backgroundColor: 'rgb(0, 106, 255)', color: 'white', paddingLeft: '14px', paddingTop: '5px'}}><h1 className='font-bold text-2xl'>Upcoming Appointments</h1></div>
